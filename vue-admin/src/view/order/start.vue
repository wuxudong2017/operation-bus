<template>
  <div class="data-table">
    ...
    <el-row>
      <el-col :span="6">
        <el-input  size="mini"   type="number"  clearable v-model="formData.keywords" placeholder="请输工单号"  @keyup.enter.native="search">
    ...
    <el-table v-loading="tabLoading" :data="tableData" stripe style="width:100%;min-height:520px;">
      ...
      <el-table-column prop="updateTime" :formatter="formatDate" width="200" label="开始时间"></el-table-column>
